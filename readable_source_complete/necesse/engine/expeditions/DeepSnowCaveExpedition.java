...
public class DeepSnowCaveExpedition
extends SettlerExpedition {
    public static LootTable ores = new LootTable(LootItem.between("glacialore", 16, 26), LootItem.between("tungstenore", 12, 22), LootItem.between("lifequartz", 8, 18));
    public static LootTable extra = new LootTable(LootItem.between("bone", 4, 12), LootItem.between("glacialshard", 4, 8), LootItem.between("ninjastar", 15, 25));
    public static LootTable rewards = new LootTable(LootTablePresets.deepSnowCaveChest, ores, extra);
    ...
    public float getSuccessChance(ServerSettlementData settlement) {
        return DeepSnowCaveExpedition.questProgressSuccessChance(settlement, "cryoqueen");
    }
    ...
    public List<InventoryItem> getItemIcons() {
        ...
        DeepCaveChestLootTable.snowMainItems.addPossibleLoot(list, new Object[0]);
