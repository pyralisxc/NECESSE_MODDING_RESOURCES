...
public class DeepPlainsCaveExpedition
extends SettlerExpedition {
    public static LootTable ores = new LootTable(LootItem.between("amber", 8, 16), LootItem.between("tungstenore", 12, 22), LootItem.between("lifequartz", 8, 16));
    public static LootTable extra = new LootTable(LootItem.between("dryadlog", 20, 35));
    public static LootTable rewards = new LootTable(LootTablePresets.deepPlainsCaveChest, ores, extra);
    ...
    public float getSuccessChance(ServerSettlementData settlement) {
        return DeepPlainsCaveExpedition.questProgressSuccessChance(settlement, "thecursedcrone");
    }
    ...
    public List<InventoryItem> getItemIcons() {
        ...
        DeepCaveChestLootTable.plainsMainItems.addPossibleLoot(list, new Object[0]);
