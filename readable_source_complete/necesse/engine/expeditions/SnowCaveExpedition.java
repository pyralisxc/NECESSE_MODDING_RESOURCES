...
public class SnowCaveExpedition
extends SettlerExpedition {
    public static LootTable ores = new LootTable(LootItem.between("copperore", 16, 26), LootItem.between("ironore", 12, 22), LootItem.between("goldore", 8, 18), LootItem.between("frostshard", 6, 14));
    public static LootTable extra = new LootTable(LootItem.between("batwing", 4, 12), LootItem.between("cavespidergland", 5, 8, MultiTextureMatItem.getGNDData(1)));
    public static LootTable rewards = new LootTable(LootTablePresets.snowCaveChest, ores, extra);
    ...
    public float getSuccessChance(ServerSettlementData settlement) {
        return SnowCaveExpedition.questProgressSuccessChance(settlement, "queenspider");
    }
    ...
    public List<InventoryItem> getItemIcons() {
        ...
        CaveChestLootTable.snowMainItems.addPossibleLoot(list, new Object[0]);
