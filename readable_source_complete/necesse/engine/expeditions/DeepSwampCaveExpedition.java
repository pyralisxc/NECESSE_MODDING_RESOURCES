...
public class DeepSwampCaveExpedition
extends SettlerExpedition {
    public static LootTable ores = new LootTable(LootItem.between("myceliumore", 16, 26), LootItem.between("tungstenore", 12, 22), LootItem.between("lifequartz", 8, 18));
    public static LootTable extra = new LootTable(LootItem.between("bone", 4, 12), LootItem.between("bonearrow", 50, 100));
    public static LootTable rewards = new LootTable(LootTablePresets.deepSwampCaveChest, ores, extra);
    ...
    public float getSuccessChance(ServerSettlementData settlement) {
        return DeepSwampCaveExpedition.questProgressSuccessChance(settlement, "pestwarden");
    }
    ...
    public List<InventoryItem> getItemIcons() {
        ...
        DeepCaveChestLootTable.swampMainItems.addPossibleLoot(list, new Object[0]);
