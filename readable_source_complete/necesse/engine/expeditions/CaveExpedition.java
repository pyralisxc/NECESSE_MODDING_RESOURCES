...
public class CaveExpedition
extends SettlerExpedition {
    public static LootTable ores = new LootTable(LootItem.between("copperore", 16, 26), LootItem.between("ironore", 12, 22), LootItem.between("goldore", 8, 18));
    public static LootTable extra = new LootTable(LootItem.between("batwing", 3, 8), LootItem.between("cavespidergland", 3, 6, MultiTextureMatItem.getGNDData(0)));
    public static LootTable rewards = new LootTable(LootTablePresets.basicCaveChest, ores, extra);
    ...
    public float getSuccessChance(ServerSettlementData settlement) {
        return CaveExpedition.questProgressSuccessChance(settlement, "evilsprotector");
    }
    ...
    public List<InventoryItem> getItemIcons() {
        ...
        CaveChestLootTable.basicMainItems.addPossibleLoot(list, new Object[0]);
