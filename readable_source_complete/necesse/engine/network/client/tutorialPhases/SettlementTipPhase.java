...
public class SettlementTipPhase
extends TutorialPhase {
    public SettlementTipPhase(ClientTutorial tutorial, Client client) {
        super(tutorial, client);
    }

    @Override
    public void updateObjective(MainGame mainGame) {
        this.setObjective(mainGame, "settlementtip", "next", (FormInputEvent e) -> this.over());
    }
}
