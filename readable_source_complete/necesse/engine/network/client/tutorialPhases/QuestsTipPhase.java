...
public class QuestsTipPhase
extends TutorialPhase {
    public QuestsTipPhase(ClientTutorial tutorial, Client client) {
        super(tutorial, client);
    }

    @Override
    public void updateObjective(MainGame mainGame) {
        this.setObjective(mainGame, "elderquestinfo", "next", (FormInputEvent e) -> this.over());
    }
}
