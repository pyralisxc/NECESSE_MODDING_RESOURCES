...
extends Packet {
    ...
    public void processServer(NetworkPacket packet, Server server, ServerClient client) {
        client.sendPacket(new PacketServerWorldStats(server.world.worldEntity.worldStats));
    }
