...
public class PacketFireDeathRipper
extends Packet {
    public final int mobUniqueID;

    public PacketFireDeathRipper(byte[] data) {
        super(data);
        PacketReader reader = new PacketReader(this);
        this.mobUniqueID = reader.getNextInt();
    }

    public PacketFireDeathRipper(Mob target) {
    ...
    public void processClient(NetworkPacket packet, Client client) {
        ...
        if (target != null) {
            DeathRipperAttackHandler.playFireSound(target);
        }
    }
}
