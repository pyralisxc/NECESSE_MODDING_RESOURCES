...
public class PacketObjectEntityNetworkFields
extends Packet {
    ...
    public PacketObjectEntityNetworkFields(byte[] data) {
        super(data);
    ...
    public PacketObjectEntityNetworkFields(ObjectEntity objectEntity, Packet content) {
    ...
    public void processClient(NetworkPacket packet, Client client) {
        ...
        if (objectEntity != null && objectEntity.getObject().getID() == this.objectID) {
            objectEntity.runNetworkFieldUpdate(new PacketReader(this.content));
        } else {
