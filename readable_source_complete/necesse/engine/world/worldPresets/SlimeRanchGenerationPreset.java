...
import necesse.level.maps.presets.SlimeRanchPreset;

public class SlimeRanchGenerationPreset
extends SimpleGenerationPreset {
    public final Biome biome;
    public final LevelIdentifier levelIdentifier;

    public SlimeRanchGenerationPreset(LevelIdentifier levelIdentifier, Biome biome) {
    ...
    public Preset getPreset(GameRandom random) {
        return new SlimeRanchPreset(this.biome, this.levelIdentifier, random);
    }
}
