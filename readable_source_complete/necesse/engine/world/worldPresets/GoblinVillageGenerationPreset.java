...
import necesse.level.maps.presets.GoblinVillagePreset;
import necesse.level.maps.presets.Preset;

public class GoblinVillageGenerationPreset
extends SimpleGenerationPreset {
    public GoblinVillageGenerationPreset(LevelIdentifier levelIdentifier, Biome biome) {
    ...
    public Preset getPreset(GameRandom random) {
        return new GoblinVillagePreset(random);
    }
}
