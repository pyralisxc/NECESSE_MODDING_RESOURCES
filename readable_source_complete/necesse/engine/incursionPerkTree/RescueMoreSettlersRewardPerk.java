...
public class RescueMoreSettlersRewardPerk
extends IncursionPerk {
    public RescueMoreSettlersRewardPerk(Integer tier, int perkCost, int xPositionOnPerkTree, IncursionPerk ... prerequisitePerkRequired) {
