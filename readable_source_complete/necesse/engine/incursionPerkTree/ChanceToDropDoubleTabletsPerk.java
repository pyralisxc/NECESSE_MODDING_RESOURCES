...
public class ChanceToDropDoubleTabletsPerk
extends IncursionPerk {
    public ChanceToDropDoubleTabletsPerk(Integer tier, int perkCost, int xPositionOnPerkTree, IncursionPerk ... prerequisitePerkRequired) {
