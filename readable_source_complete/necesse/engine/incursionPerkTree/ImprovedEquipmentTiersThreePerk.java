...
public class ImprovedEquipmentTiersThreePerk
extends IncursionPerk {
    public ImprovedEquipmentTiersThreePerk(Integer tier, int perkCost, int xPositionOnPerkTree, IncursionPerk ... prerequisitePerkRequired) {
