...
public class FlamelingsCanDiePerk
extends IncursionPerk {
    public FlamelingsCanDiePerk(Integer tier, int perkCost, int xPositionOnPerkTree, IncursionPerk ... prerequisitePerkRequired) {
    ...
    public void onIncursionLevelGenerated(IncursionLevel level, AltarData altarData, int modifierIndex) {
        FlamelingsCanDiePerkLevelEvent event = new FlamelingsCanDiePerkLevelEvent();
