...
public class MobsDropMoreAltarDustPerk
extends IncursionPerk {
    public MobsDropMoreAltarDustPerk(Integer tier, int perkCost, int xPositionOnPerkTree, IncursionPerk ... prerequisitePerkRequired) {
    ...
    public void onIncursionLevelGenerated(IncursionLevel level, AltarData altarData, int modifierIndex) {
        MobsDropMoreAltarDustPerkLevelEvent event = new MobsDropMoreAltarDustPerkLevelEvent();
