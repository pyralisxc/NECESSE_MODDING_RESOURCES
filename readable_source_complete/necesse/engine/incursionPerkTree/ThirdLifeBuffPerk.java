...
public class ThirdLifeBuffPerk
extends IncursionPerk {
    public ThirdLifeBuffPerk(Integer tier, int perkCost, int xPositionOnPerkTree, IncursionPerk ... prerequisitePerkRequired) {
    ...
    public void onIncursionLevelGenerated(IncursionLevel level, AltarData altarData, int modifierIndex) {
        SecondLifePerkLevelEvent event = new SecondLifePerkLevelEvent(2);
