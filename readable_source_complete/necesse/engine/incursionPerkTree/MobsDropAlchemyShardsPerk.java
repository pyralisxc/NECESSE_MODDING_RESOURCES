...
public class MobsDropAlchemyShardsPerk
extends IncursionPerk {
    public MobsDropAlchemyShardsPerk(Integer tier, int perkCost, int xPositionOnPerkTree, IncursionPerk ... prerequisitePerkRequired) {
