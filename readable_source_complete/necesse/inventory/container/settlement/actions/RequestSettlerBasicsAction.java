...
public class RequestSettlerBasicsAction
extends SettlementAccessRequiredContainerCustomAction {
    public RequestSettlerBasicsAction(SettlementDependantContainer container) {
        super(container);
    }
    ...
    public void executePacket(PacketReader reader, ServerSettlementData data, ServerClient client) {
        new SettlementSettlerBasicsEvent(data).applyAndSendToClient(client);
    }
}
