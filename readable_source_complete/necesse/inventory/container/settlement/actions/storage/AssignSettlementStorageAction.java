...
public class AssignSettlementStorageAction
extends ContainerCustomAction {
    public final SettlementContainer container;

    public AssignSettlementStorageAction(SettlementContainer container) {
    ...
    public void executePacket(PacketReader reader) {
        ...
        if (this.container.client.isServer()) {
            ...
            if (serverData != null) {
                ...
                serverData.storageManager.assignStorage(x, y, true);
            } else {
