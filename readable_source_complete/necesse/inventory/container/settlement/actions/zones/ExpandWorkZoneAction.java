...
public class ExpandWorkZoneAction
extends ContainerCustomAction {
    public final SettlementDependantContainer container;

    public ExpandWorkZoneAction(SettlementDependantContainer container) {
        this.container = container;
    }

    public void runAndSend(int uniqueID, Rectangle rectangle, Point anchor) {
    ...
    public void executePacket(PacketReader reader) {
        ...
        if (this.container.client.isServer()) {
            ...
            if (serverData != null) {
                ...
                SettlementWorkZone zone = serverData.getWorkZones().expandZone(uniqueID, rectangle, anchor, client);
                if (zone != null) {
