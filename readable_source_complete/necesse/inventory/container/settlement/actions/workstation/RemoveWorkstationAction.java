...
public class RemoveWorkstationAction
extends ContainerCustomAction {
    public final SettlementDependantContainer container;

    public RemoveWorkstationAction(SettlementDependantContainer container) {
    ...
    public void executePacket(PacketReader reader) {
        ...
        if (this.container.client.isServer()) {
            ...
            if (serverData != null) {
                ...
                serverData.storageManager.removeWorkstation(x, y, true);
            } else {
