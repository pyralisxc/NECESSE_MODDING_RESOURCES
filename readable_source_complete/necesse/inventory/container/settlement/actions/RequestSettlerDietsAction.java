...
public class RequestSettlerDietsAction
extends SettlementAccessRequiredContainerCustomAction {
    public RequestSettlerDietsAction(SettlementContainer container) {
        super(container);
    }
    ...
    public void executePacket(PacketReader reader, ServerSettlementData data, ServerClient client) {
        new SettlementSettlerDietsEvent(data).applyAndSendToClient(client);
    }
}
