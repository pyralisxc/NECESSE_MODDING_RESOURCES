...
public class RequestSettlerPrioritiesAction
extends SettlementAccessRequiredContainerCustomAction {
    public RequestSettlerPrioritiesAction(SettlementContainer container) {
        super(container);
    }
    ...
    public void executePacket(PacketReader reader, ServerSettlementData data, ServerClient client) {
        new SettlementSettlerPrioritiesEvent(data).applyAndSendToClient(client);
    }
}
