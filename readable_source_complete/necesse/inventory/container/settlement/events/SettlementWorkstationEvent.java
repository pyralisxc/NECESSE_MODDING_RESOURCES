...
public class SettlementWorkstationEvent
extends ContainerEvent {
    ...
    public SettlementWorkstationEvent(ServerSettlementData data, SettlementWorkstation workstation) {
    ...
    public SettlementWorkstationEvent(PacketReader reader) {
        super(reader);
