...
public class PvPJoinRequestUpdateEvent
extends ContainerEvent {
    public long auth;
    public boolean added;
    public String name;

    public PvPJoinRequestUpdateEvent(long auth, boolean added, String name) {
        this.auth = auth;
        this.added = added;
        this.name = name;
    }

    public PvPJoinRequestUpdateEvent(PacketReader reader) {
        super(reader);
