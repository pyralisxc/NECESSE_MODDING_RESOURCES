...
public class SpideriteCrownArmorItem
extends SetHelmetArmorItem {
    public GameTexture lightTexture;

    public SpideriteCrownArmorItem() {
        super(16, DamageTypeRegistry.SUMMON, 1900, IncursionHeadArmorLootTable.incursionHeadArmor, IncursionArmorSetsLootTable.incursionArmorSets, Item.Rarity.EPIC, "spideritecrown", "spideritechestplate", "spideritegreaves", "spideritecrownsetbonus");
    ...
    public ArmorModifiers getArmorModifiers(InventoryItem item, Mob mob) {
        return new ArmorModifiers(new ModifierValue<Float>(BuffModifiers.SUMMON_DAMAGE, Float.valueOf(0.15f)), new ModifierValue<Float>(BuffModifiers.SUMMONS_SPEED, Float.valueOf(0.3f)), new ModifierValue<Integer>(BuffModifiers.MAX_SUMMONS, 1));
    }
