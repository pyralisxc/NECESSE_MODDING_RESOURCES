...
public class SpideriteHoodArmorItem
extends SetHelmetArmorItem {
    public GameTexture lightTexture;

    public SpideriteHoodArmorItem() {
        super(23, DamageTypeRegistry.RANGED, 1900, IncursionHeadArmorLootTable.incursionHeadArmor, IncursionArmorSetsLootTable.incursionArmorSets, Item.Rarity.EPIC, "spideritehood", "spideritechestplate", "spideritegreaves", "spideritesetbonus");
    ...
    public ArmorModifiers getArmorModifiers(InventoryItem item, Mob mob) {
        return new ArmorModifiers(new ModifierValue<Float>(BuffModifiers.RANGED_ATTACK_SPEED, Float.valueOf(0.15f)), new ModifierValue<Integer>(BuffModifiers.ARMOR_PEN_FLAT, 15));
    }
