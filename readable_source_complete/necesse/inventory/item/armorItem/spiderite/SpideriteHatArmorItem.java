...
public class SpideriteHatArmorItem
extends SetHelmetArmorItem {
    public GameTexture lightTexture;

    public SpideriteHatArmorItem() {
        super(21, DamageTypeRegistry.MAGIC, 1900, IncursionHeadArmorLootTable.incursionHeadArmor, IncursionArmorSetsLootTable.incursionArmorSets, Item.Rarity.EPIC, "spideritehat", "spideritechestplate", "spideritegreaves", "spideritehatsetbonus");
        ...
        this.hairMaskTextureName = "spideritehat_hairmask";
    ...
    public ArmorModifiers getArmorModifiers(InventoryItem item, Mob mob) {
        return new ArmorModifiers(new ModifierValue<Float>(BuffModifiers.MAGIC_ATTACK_SPEED, Float.valueOf(0.15f)), new ModifierValue<Float>(BuffModifiers.MANA_USAGE, Float.valueOf(-0.15f)));
    }
