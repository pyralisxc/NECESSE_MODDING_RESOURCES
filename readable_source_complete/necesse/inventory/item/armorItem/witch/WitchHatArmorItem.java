...
public class WitchHatArmorItem
extends SetHelmetArmorItem {
    public FloatUpgradeValue manaRegen = new FloatUpgradeValue().setBaseValue(1.0f).setUpgradedValue(1.0f, 1.5f);

    public WitchHatArmorItem() {
        super(12, DamageTypeRegistry.MAGIC, 850, HeadArmorLootTable.headArmor, ArmorSetsLootTable.armorSets, Item.Rarity.UNCOMMON, "witchhat", "witchrobe", "witchshoes", "witchrobessetbonus");
