...
public class RunicHatArmorItem
extends SetHelmetArmorItem {
    public GameTexture lightTexture;

    public RunicHatArmorItem() {
        super(9, DamageTypeRegistry.MAGIC, 750, HeadArmorLootTable.headArmor, ArmorSetsLootTable.armorSets, Item.Rarity.UNCOMMON, "runichat", "runicchestplate", "runicboots", "runichatsetbonus");
    ...
    public ArmorModifiers getArmorModifiers(InventoryItem item, Mob mob) {
        return new ArmorModifiers(new ModifierValue<Float>(BuffModifiers.MAGIC_CRIT_CHANCE, Float.valueOf(0.1f)), new ModifierValue<Float>(BuffModifiers.LIFE_ESSENCE_GAIN, Float.valueOf(1.0f)));
    }
