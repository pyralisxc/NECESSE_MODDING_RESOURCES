...
public class RunicHelmetArmorItem
extends SetHelmetArmorItem {
    public GameTexture lightTexture;

    public RunicHelmetArmorItem() {
        super(11, DamageTypeRegistry.MELEE, 750, HeadArmorLootTable.headArmor, ArmorSetsLootTable.armorSets, Item.Rarity.UNCOMMON, "runichelmet", "runicchestplate", "runicboots", "runicsetbonus");
        this.hairDrawOptions = ArmorItem.HairDrawMode.NO_HEAD;
    }

    @Override
    public ArmorModifiers getArmorModifiers(InventoryItem item, Mob mob) {
        return new ArmorModifiers(new ModifierValue<Float>(BuffModifiers.MELEE_DAMAGE, Float.valueOf(0.05f)), new ModifierValue<Float>(BuffModifiers.MELEE_CRIT_CHANCE, Float.valueOf(0.1f)));
    }
