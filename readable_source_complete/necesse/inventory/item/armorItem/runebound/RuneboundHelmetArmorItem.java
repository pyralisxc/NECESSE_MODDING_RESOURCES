...
public class RuneboundHelmetArmorItem
extends SetHelmetArmorItem {
    public RuneboundHelmetArmorItem() {
        super(0, null, 0, CosmeticArmorLootTable.cosmeticArmor, CosmeticSetArmorLootTable.cosmeticSetArmor, Item.Rarity.COMMON, "runeboundhelmet", "runeboundleatherchest", "runeboundboots", null);
        this.hairDrawOptions = ArmorItem.HairDrawMode.OVER_HAIR;
        this.hairMaskTextureName = "runeboundhelmet_hairmask";
