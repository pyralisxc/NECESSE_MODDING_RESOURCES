...
public class DryadChestplateArmorItem
extends ChestArmorItem {
    public DryadChestplateArmorItem() {
        super(26, 1550, Item.Rarity.UNCOMMON, "dryadchestplate", "dryadarms", BodyArmorLootTable.bodyArmor);
    }
