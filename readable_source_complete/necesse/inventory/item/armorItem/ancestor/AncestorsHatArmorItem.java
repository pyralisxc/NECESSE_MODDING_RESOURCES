 ...
 */
package necesse.inventory.item.armorItem.ancestor;
...
public class AncestorsHatArmorItem
extends SetHelmetArmorItem {
    public FloatUpgradeValue manaRegen = new FloatUpgradeValue().setBaseValue(1.5f).setUpgradedValue(1.0f, 1.5f);

    public AncestorsHatArmorItem() {
        super(20, DamageTypeRegistry.MAGIC, 1750, HeadArmorLootTable.headArmor, ArmorSetsLootTable.armorSets, Item.Rarity.UNCOMMON, "ancestorshat", "ancestorsrobe", "ancestorsboots", "ancestorsetbonus");
