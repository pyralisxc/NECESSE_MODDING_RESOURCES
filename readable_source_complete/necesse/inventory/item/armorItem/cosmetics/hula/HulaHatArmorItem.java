 ...
 */
package necesse.inventory.item.armorItem.cosmetics.hula;
...
public class HulaHatArmorItem
extends SetHelmetArmorItem {
    public HulaHatArmorItem() {
        super(0, null, 0, CosmeticArmorLootTable.cosmeticArmor, CosmeticSetArmorLootTable.cosmeticSetArmor, Item.Rarity.UNCOMMON, "hulahat", "hulaskirtwithtop", "hulaskirt", null);
