...
public class BashyBushSummonToolItem
extends SummonToolItem {
    public BashyBushSummonToolItem() {
        super("bashybushfollowingmob", FollowPosition.WALK_CLOSE, 1.0f, 400, SummonWeaponsLootTable.summonWeapons);
        this.rarity = Item.Rarity.UNCOMMON;
        this.attackAnimTime.setBaseValue(300);
        this.attackDamage.setBaseValue(18.0f).setUpgradedValue(1.0f, 53.66668f);
    ...
    public ListGameTooltips getPreEnchantmentTooltips(InventoryItem item, PlayerMob perspective, GameBlackboard blackboard) {
        ...
        tooltips.add(Localization.translate("itemtooltip", "bashybushtip"), 400);
        return tooltips;
    }
    ...
    public void summonServerMob(ItemAttackerMob attackerMob, ToolItemSummonedMob mob, int x, int y, int attackHeight, InventoryItem item) {
        int distance;
        attackerMob.startGenericCooldown("bashyBushSummon", 5000L);
        int xOffset = -15;
        ...
        BashyBushSpawnProjectile projectile = new BashyBushSpawnProjectile(attackerMob.getLevel(), attackerMob, startPoints.x, startPoints.y, targetPoints.x, targetPoints.y, castSpeed, distance, new GameDamage(0.0f), 0, this, item);
