...
public class CaveOysterQuestItem
extends QuestFishItem {
    ...
    public FishingLootTable getExtraFishingLoot(ServerClient client, FishingSpot spot) {
        if (spot.getBiome() instanceof DesertBiome && spot.tile.level.isCave && client.playerMob.getInv().getAmount(this, false, false, true, true, "questdrop") <= 0) {
