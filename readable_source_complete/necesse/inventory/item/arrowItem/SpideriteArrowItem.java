...
public class SpideriteArrowItem
extends ArrowItem {
    ...
    public Projectile getProjectile(float x, float y, float targetX, float targetY, float velocity, int range, GameDamage damage, int knockback, ItemAttackerMob owner) {
        return ProjectileRegistry.getProjectile("spideritearrow", owner.getLevel(), x, y, targetX, targetY, velocity, range, damage, knockback, (Mob)owner);
    }
}
