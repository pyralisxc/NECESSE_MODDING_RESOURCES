...
public class GreaterAttackSpeedPotionItem
extends SimplePotionItem {
    public GreaterAttackSpeedPotionItem() {
        super(100, Item.Rarity.RARE, "greaterattackspeedpotion", 300, "greaterattackspeedpot");
