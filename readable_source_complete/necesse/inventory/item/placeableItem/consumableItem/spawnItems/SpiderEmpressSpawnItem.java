...
public class SpiderEmpressSpawnItem
extends ConsumableItem {
    ...
    public InventoryItem onPlace(Level level, int x, int y, PlayerMob player, int seed, InventoryItem item, GNDItemMap mapContent) {
        if (level.isServer()) {
            ...
            if (level instanceof IncursionLevel && (summonError = ((IncursionLevel)level).canSummonBoss("spiderempress")) != null) {
                if (player != null && player.isServerClient()) {
                    player.getServerClient().sendChatMessage(summonError);
                }
                return item;
            }
            System.out.println("The Spider Empress has been summoned at " + level.getIdentifier() + ".");
            ...
            Mob mob = MobRegistry.getMob("spiderempress", level);
    ...
    public ListGameTooltips getTooltips(InventoryItem item, PlayerMob perspective, GameBlackboard blackboard) {
        ...
        tooltips.add(Localization.translate("itemtooltip", "crownofspiderkintip"));
        tooltips.add(Localization.translate("itemtooltip", "spiderempresssummontip"));
        return tooltips;
    }
