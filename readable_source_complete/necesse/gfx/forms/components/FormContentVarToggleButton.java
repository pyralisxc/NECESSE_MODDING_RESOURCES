...
public abstract class FormContentVarToggleButton
extends FormButton
implements FormPositionContainer {
    ...
    public FormContentVarToggleButton(int x, int y, int width, FormInputSize size, ButtonColor color, Supplier<Boolean> isToggled) {
    ...
    public List<Rectangle> getHitboxes() {
        return FormContentVarToggleButton.singleBox(new Rectangle(this.getX(), this.getY() + this.size.textureDrawOffset, this.width, this.size.height));
    }
    ...
    public boolean isButtonDown() {
        return this.useDownTexture && this.isToggled.get() != false || this.isDown() && this.isHovering();
    }

    public boolean isToggled() {
        return this.isToggled.get();
    }
}
