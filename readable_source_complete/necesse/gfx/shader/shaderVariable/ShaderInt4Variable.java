...
extends ShaderVariable<Integer[]> {
    ...
    protected void apply(GameShader shader, int[] variable) {
        shader.use();
        shader.pass4i(this.varName, variable[0], variable[1], variable[2], variable[3]);
        shader.stop();
    }
}
