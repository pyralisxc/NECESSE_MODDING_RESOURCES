...
extends ShaderVariable<Float[]> {
    ...
    protected void apply(GameShader shader, float[] variable) {
        shader.use();
        shader.pass2f(this.varName, variable[0], variable[1]);
        shader.stop();
    }
}
