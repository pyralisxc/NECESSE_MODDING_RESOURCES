...
public class SapphireStaffGlyphParticle
extends Particle {
    private float alpha = 0.0f;

    public SapphireStaffGlyphParticle(Level level, float x, float y, long lifeTime) {
    ...
    public void addDrawables(List<LevelSortedDrawable> list, OrderableDrawables tileList, OrderableDrawables topList, OrderableDrawables overlayList, Level level, TickManager tickManager, GameCamera camera, PlayerMob perspective) {
        ...
        TextureDrawOptionsEnd options = GameResources.sapphireGlyphParticle.initDraw().light(light).alpha(this.alpha).pos(drawX, drawY).posMiddle(drawX, drawY);
