...
public class AscendedVoidStarParticle
extends Particle {
    private final GameTexture animTexture = GameResources.ascendedVoidStarParticles;
    private final int spriteRes;

    public AscendedVoidStarParticle(Level level, float x, float y, long lifeTime) {
