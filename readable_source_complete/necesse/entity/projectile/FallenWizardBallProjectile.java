...
public class FallenWizardBallProjectile
extends Projectile {
    public FallenWizardBallProjectile() {
    }

    public FallenWizardBallProjectile(Level level, Mob owner, float x, float y, float angle, float speed, int distance, GameDamage damage, int knockback) {
        this.setLevel(level);
        this.setOwner(owner);
        this.x = x;
        this.y = y;
