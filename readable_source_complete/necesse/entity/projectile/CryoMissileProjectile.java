...
public class CryoMissileProjectile
extends Projectile {
    public CryoMissileProjectile() {
    }

    public CryoMissileProjectile(Level level, Mob owner, float x, float y, float targetX, float targetY, float speed, int distance, GameDamage damage, int knockback) {
        this.setLevel(level);
        this.setOwner(owner);
        this.x = x;
        this.y = y;
