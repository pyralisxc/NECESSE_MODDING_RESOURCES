...
public class NinjaStarProjectile
extends Projectile
implements RicochetableProjectile {
    public NinjaStarProjectile() {
    }

    public NinjaStarProjectile(float x, float y, float targetX, float targetY, GameDamage damage, Mob owner) {
        this.x = x;
        this.y = y;
    ...
    protected SoundSettings getSpawnSound() {
        return new SoundSettings(GameResources.ninjaStar).volume(0.6f);
    }
}
