...
public class ElderlyWandProjectile
extends FollowingProjectile {
    public ElderlyWandProjectile() {
    }

    public ElderlyWandProjectile(float x, float y, float targetX, float targetY, float speed, int distance, GameDamage damage, int knockback, Mob owner) {
