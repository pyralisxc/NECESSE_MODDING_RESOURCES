...
public class PlayerCirclingFlipFollowerCollisionChaserAI<T extends Mob>
extends SelectorAINode<T> {
    public PlayerCirclingFlipFollowerCollisionChaserAI(int searchDistance, final GameDamage damage, final int knockback, int teleportDistance, int circlingRange) {
        ...
        this.addChild(new PlayerFlyingFollowerAINode(teleportDistance, circlingRange));
    }
}
