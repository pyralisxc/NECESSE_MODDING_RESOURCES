...
public class PlayerFlyingFollowerCollisionChaserAI<T extends Mob>
extends SelectorAINode<T> {
    public PlayerFlyingFollowerCollisionChaserAI(int searchDistance, final GameDamage damage, final int knockback, int hitCooldown, int teleportDistance, int stoppingDistance) {
