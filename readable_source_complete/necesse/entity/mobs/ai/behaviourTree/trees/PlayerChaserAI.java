...
public abstract class PlayerChaserAI<T extends Mob>
extends ChaserAI<T> {
    public PlayerChaserAI(int searchDistance, int shootDistance, boolean smartPositioning, boolean changePositionOnHit) {
