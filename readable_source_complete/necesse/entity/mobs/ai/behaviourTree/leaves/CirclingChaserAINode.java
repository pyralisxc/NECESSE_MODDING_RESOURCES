...
public class CirclingChaserAINode<T extends Mob>
extends AINode<T> {
    ...
    public CirclingChaserAINode(int circlingRange, int nextAngleOffset) {
    ...
    public void findNewPosition(T mob) {
        int angle = this.lastAngle += GameRandom.globalRandom.getIntOffset(180, this.nextAngleOffset);
