...
public class EmeraldGlyphBuff
extends Buff {
    public EmeraldGlyphBuff() {
    ...
    public void init(ActiveBuff buff, BuffEventSubscriber eventSubscriber) {
        buff.setModifier(BuffModifiers.CRIT_CHANCE, Float.valueOf(0.35f));
    }
    ...
    public ListGameTooltips getTooltip(ActiveBuff ab, GameBlackboard blackboard) {
        ...
        tooltips.add(Localization.translate("bufftooltip", "emeraldglyphtip"));
        return tooltips;
    }
}
