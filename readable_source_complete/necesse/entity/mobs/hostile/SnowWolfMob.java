...
extends HostileMob {
    ...
    public void init() {
        ...
        this.ai = new BehaviourTreeAI<SnowWolfMob>(this, new ConfusedCollisionPlayerChaserWandererAI(null, 512, damage, 100, 40000));
    }
    ...
    public void addDrawables(List<MobDrawable> list, OrderableDrawables tileList, OrderableDrawables topList, Level level, int x, int y, TickManager tickManager, GameCamera camera, PlayerMob perspective) {
        ...
        GameLight light = level.getLightLevel(SnowWolfMob.getTileCoordinate(x), SnowWolfMob.getTileCoordinate(y));
        ...
        final TextureDrawOptionsEnd body = MobRegistry.Textures.snowWolf.body.initDraw().sprite(sprite.x, sprite.y, 64).addMaskShader(swimMask).light(light).pos(drawX, drawY += level.getTile(SnowWolfMob.getTileCoordinate(x), SnowWolfMob.getTileCoordinate(y)).getMobSinkingAmount(this));
