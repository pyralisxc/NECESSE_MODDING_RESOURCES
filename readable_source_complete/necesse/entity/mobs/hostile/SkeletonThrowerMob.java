...
public class SkeletonThrowerMob
extends HostileMob {
    ...
    public void init() {
        ...
        this.ai = new BehaviourTreeAI<SkeletonThrowerMob>(this, new ConfusedPlayerChaserWandererAI<SkeletonThrowerMob>(null, 512, 320, 40000, false, false){

            @Override
            public boolean attackTarget(SkeletonThrowerMob mob, Mob target) {
    ...
    public void addDrawables(List<MobDrawable> list, OrderableDrawables tileList, OrderableDrawables topList, Level level, int x, int y, TickManager tickManager, GameCamera camera, PlayerMob perspective) {
        ...
        GameLight light = level.getLightLevel(SkeletonThrowerMob.getTileCoordinate(x), SkeletonThrowerMob.getTileCoordinate(y));
        int drawX = camera.getDrawX(x) - 22 - 10;
        int drawY = camera.getDrawY(y) - 44 - 7;
        int dir = this.getDir();
        Point sprite = this.getAnimSprite(x, y, dir);
        drawY += this.getBobbing(x, y);
        drawY += level.getTile(SkeletonThrowerMob.getTileCoordinate(x), SkeletonThrowerMob.getTileCoordinate(y)).getMobSinkingAmount(this);
