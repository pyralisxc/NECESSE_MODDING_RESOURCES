...
public class RuneboundShamanMob
extends HostileItemAttackerMob {
    public static LootTable lootTable = new LootTable(ChanceLootItem.between(0.1f, "runestone", 1, 2), ChanceLootItem.between(0.3f, "clothscraps", 1, 3), ChanceLootItem.between(0.2f, "coin", 2, 16).splitItems(2), new ChanceLootItem(0.05f, "manapotion"), new ChanceLootItem(0.05f, "raspberryjuice"));
    ...
    public void init() {
        super.init();
        this.updateLook();
        this.ai = new BehaviourTreeAI<RuneboundShamanMob>(this, new ConfusedItemAttackerPlayerChaserWandererAI(null, 512, RuneboundShamanMob.getAIRuneboundScepter(), 40000));
    }

    public static InventoryItem getAIRuneboundScepter() {
        InventoryItem inventoryItem = new InventoryItem("runeboundscepter");
    ...
    public void updateLook() {
        GameRandom random = new GameRandom(this.lookSeed);
        HumanGender gender = random.getOneOfWeighted(HumanGender.class, new Object[]{30, HumanGender.MALE, 60, HumanGender.FEMALE, 10, HumanGender.NEUTRAL});
    ...
    public void addDrawables(List<MobDrawable> list, OrderableDrawables tileList, OrderableDrawables topList, Level level, int x, int y, TickManager tickManager, GameCamera camera, PlayerMob perspective) {
        ...
        GameLight light = level.getLightLevel(RuneboundShamanMob.getTileCoordinate(x), RuneboundShamanMob.getTileCoordinate(y));
        ...
        drawY += level.getTile(RuneboundShamanMob.getTileCoordinate(x), RuneboundShamanMob.getTileCoordinate(y)).getMobSinkingAmount(this);
