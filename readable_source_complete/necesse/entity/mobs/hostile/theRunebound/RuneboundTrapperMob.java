...
public class RuneboundTrapperMob
extends HostileItemAttackerMob {
    public static LootTable lootTable = new LootTable(ChanceLootItem.between(0.05f, "runestone", 1, 2), ChanceLootItem.between(0.3f, "clothscraps", 1, 3), ChanceLootItem.between(0.2f, "coin", 2, 16).splitItems(2), ChanceLootItem.between(0.05f, "bouncingarrow", 8, 24).splitItems(2), ChanceLootItem.between(0.05f, "poisonarrow", 8, 24).splitItems(2));
    public int lookSeed;
    ...
    public void init() {
        super.init();
        this.updateLook();
        this.ai = new BehaviourTreeAI<RuneboundTrapperMob>(this, new ConfusedItemAttackerPlayerChaserWandererAI(null, 512, RuneboundTrapperMob.getAICaptorsShortbow(), 40000));
    }

    public static InventoryItem getAICaptorsShortbow() {
        InventoryItem inventoryItem = new InventoryItem("captorsshortbow");
    ...
    public void getSeededRandomRuneboundShamanGear() {
        ...
        String helmetID = random.getOneOfWeighted(String.class, 60, "runeboundskullhelmet", 20, "runeboundhood");
        String chestID = random.getOneOf("runeboundleatherchest", "runeboundrobe");
    ...
    public void updateLook() {
        GameRandom random = new GameRandom(this.lookSeed);
        HumanGender gender = random.getOneOfWeighted(HumanGender.class, new Object[]{45, HumanGender.MALE, 45, HumanGender.FEMALE, 10, HumanGender.NEUTRAL});
    ...
    public void addDrawables(List<MobDrawable> list, OrderableDrawables tileList, OrderableDrawables topList, Level level, int x, int y, TickManager tickManager, GameCamera camera, PlayerMob perspective) {
        ...
        GameLight light = level.getLightLevel(RuneboundTrapperMob.getTileCoordinate(x), RuneboundTrapperMob.getTileCoordinate(y));
        ...
        drawY += level.getTile(RuneboundTrapperMob.getTileCoordinate(x), RuneboundTrapperMob.getTileCoordinate(y)).getMobSinkingAmount(this);
