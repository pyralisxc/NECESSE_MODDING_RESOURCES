...
public class SmallGroundWebEvent
extends GroundEffectEvent {
    ...
    public SmallGroundWebEvent(Mob owner, int x, int y, GameRandom uniqueIDRandom) {
    ...
    public void init() {
        ...
        this.tickCounter = 0;
        if (this.isClient()) {
            this.level.entityManager.addParticle(new SmallGroundWebParticle(this.level, this.x, this.y, 5000L), Particle.GType.CRITICAL);
        }
    }
