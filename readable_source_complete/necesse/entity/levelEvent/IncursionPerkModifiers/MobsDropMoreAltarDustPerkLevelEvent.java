...
public class MobsDropMoreAltarDustPerkLevelEvent
extends LevelEvent
implements MobLootTableDropsListenerEntityComponent {
    LootTable altarDustLootTable = new LootTable(ChanceLootItem.between(0.2f, "altardust", 1, 3));

    public MobsDropMoreAltarDustPerkLevelEvent() {
        super(true);
