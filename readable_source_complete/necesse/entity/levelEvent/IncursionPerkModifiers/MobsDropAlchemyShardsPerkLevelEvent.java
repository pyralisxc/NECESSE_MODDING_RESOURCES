...
public class MobsDropAlchemyShardsPerkLevelEvent
extends LevelEvent
implements MobLootTableDropsListenerEntityComponent {
    LootTable altarDustLootTable = new LootTable(ChanceLootItem.between(0.1f, "alchemyshard", 2, 4));

    public MobsDropAlchemyShardsPerkLevelEvent() {
        super(true);
