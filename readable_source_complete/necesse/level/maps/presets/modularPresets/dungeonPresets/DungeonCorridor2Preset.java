...
public class DungeonCorridor2Preset
extends DungeonPreset {
    public DungeonCorridor2Preset(GameRandom random) {
        super(1, 1, random);
        ...
        this.open(0, 0, 0);
        this.open(0, 0, 2);
        this.indicatePlaceForRandomSpellTrap(3, 7);
        this.indicatePlaceForRandomSpellTrap(11, 7);
    }
}
