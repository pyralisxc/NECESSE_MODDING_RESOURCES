...
public class CabinetsPreset
extends Preset {
    public CabinetsPreset(FurnitureSet set, int frontSpace, int count, Preset.ApplyPredicateFunction wallPredicate) {
        super(count, 1 + frontSpace);
        for (int i = 0; i < count; ++i) {
            this.setObject(i, 0, set.cabinet, 2);
        }
    ...
    public CabinetsPreset(FurnitureSet set, int frontSpace, int count) {
