...
public class ForestDeepCaveIncursionLevel
extends IncursionLevel {
    public ForestDeepCaveIncursionLevel(LevelIdentifier identifier, int width, int height, WorldEntity worldEntity) {
        super(identifier, width, height, worldEntity);
    }

    public ForestDeepCaveIncursionLevel(LevelIdentifier identifier, BiomeMissionIncursionData incursion, WorldEntity worldEntity, AltarData altarData) {
        super(identifier, 150, 150, incursion, worldEntity);
        this.baseBiome = BiomeRegistry.FOREST_DEEP_CAVE_INCURSION;
        this.isCave = true;
    ...
    public void generateLevel(BiomeMissionIncursionData incursionData, AltarData altarData) {
        ...
        IncursionBiome.generateEntrance(this, entranceAndPerkPresets, cg.random, 30, cg.rockTile, "deepstonebrickfloor", "deepstonefloor", "deepstonecolumn");
        ...
        this.generateUpgradeAndAlchemyVeinsBasedOnPerks(altarData, cg, "upgradesharddeeprock", "alchemysharddeeprock", cg.random);
