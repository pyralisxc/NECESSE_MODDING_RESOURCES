...
public class HungrySettlementNotification
extends SettlementNotification {
    ...
    public GameTooltips getTooltip(SettlementNotificationManager.ActiveNotification notification) {
        ...
        tooltips.add(Localization.translate("ui", "notificationhungry"), 400);
        tooltips.add(new StringTooltips(Localization.translate("ui", "notificationhungryassign"), GameColor.GRAY, 400));
    ...
    public void onClicked(Client client, SettlementNotificationManager.ActiveNotification data) {
        HelpForms.openHelpForm("settlerhungry", new Object[0]);
    }

    @Override
    public boolean isStillValid(SettlerMob settlerMob) {
        if (settlerMob.doesEatFood() && settlerMob instanceof HungerMob) {
            return ((HungerMob)((Object)settlerMob)).isNoFoodNotificationStillValid();
        }
        return false;
    }
