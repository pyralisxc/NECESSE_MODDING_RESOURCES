...
public class TheCursedCroneTier
extends SimpleBossSettlementQuestTier {
    ...
    public static LootTable tierCompleteRewards = new LootTable(new LootItem("missionboard"));

    public TheCursedCroneTier() {
        super("thecursedcrone", "thecursedcrone");
    }
