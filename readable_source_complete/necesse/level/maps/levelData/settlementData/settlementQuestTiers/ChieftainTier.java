...
extends SimpleBossSettlementQuestTier {
    ...
    public static LootTable tierCompleteRewards = new LootTable(new LootItem("shippingchest"));

    public ChieftainTier() {
        super("chieftain", "chieftain");
    }
