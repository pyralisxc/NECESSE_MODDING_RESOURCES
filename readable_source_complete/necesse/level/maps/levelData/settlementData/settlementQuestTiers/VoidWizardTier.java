...
extends SimpleBossSettlementQuestTier {
    ...
    static {
        tierQuests.add(d -> new DeliverItemsSettlementQuest(d.getSettlementName(), null, "enchantedcollar", 1));
        tierQuests.add(d -> new DeliverItemsSettlementQuest(d.getSettlementName(), null, "apprenticescroll", 1));
        tierQuests.add(d -> new DeliverItemsSettlementQuest(d.getSettlementName(), null, "darkgem", 1));
        tierQuests.add(d -> new DeliverItemsSettlementQuest(d.getSettlementName(), null, "book", 4));
        tierCompleteRewards = new LootTable(new LootItem("voidpouch"));
    }
}
