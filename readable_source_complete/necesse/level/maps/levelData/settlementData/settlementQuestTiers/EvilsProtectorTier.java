...
public class EvilsProtectorTier
extends SimpleBossSettlementQuestTier {
    ...
    public EvilsProtectorTier() {
        super("evilsprotector", "evilsprotector");
    }
    ...
    static {
        tierQuests.add(d -> new DeliverItemsSettlementQuest(d.getSettlementName(), null, "zombiearm", 1));
        tierQuests.add(d -> new DeliverItemsSettlementQuest(d.getSettlementName(), null, "goblinring", 1));
        tierQuests.add(d -> new DeliverItemsSettlementQuest(d.getSettlementName(), null, "fakefangs", 1));
        tierCompleteRewards = new LootTable(new LootItem("lunchbox"));
    }
}
