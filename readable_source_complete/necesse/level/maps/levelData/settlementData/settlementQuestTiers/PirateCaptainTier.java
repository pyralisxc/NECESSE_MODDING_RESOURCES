...
public class PirateCaptainTier
extends SimpleBossSettlementQuestTier {
    ...
    public PirateCaptainTier() {
        super("piratecaptain", "piratecaptain");
    }
    ...
    static {
        tierQuests.add(d -> new DeliverItemsSettlementQuest(d.getSettlementName(), null, "pegleg", 1));
        tierQuests.add(d -> new DeliverItemsSettlementQuest(d.getSettlementName(), null, "eyepatch", 1));
        tierQuests.add(d -> new DeliverItemsSettlementQuest(d.getSettlementName(), null, "rumbottle", 1));
        tierCompleteRewards = new LootTable(new LootItem("coinpouch"));
    }
}
