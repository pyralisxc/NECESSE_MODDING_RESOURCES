...
extends SimpleBossSettlementQuestTier {
    ...
    static {
        tierQuests.add(d -> new DeliverItemsSettlementQuest(d.getSettlementName(), null, "feraltail", 1));
        tierQuests.add(d -> new DeliverItemsSettlementQuest(d.getSettlementName(), null, "razoricicle", 1));
        tierCompleteRewards = new LootTable(new LootItem("bannerstand"));
    }
}
