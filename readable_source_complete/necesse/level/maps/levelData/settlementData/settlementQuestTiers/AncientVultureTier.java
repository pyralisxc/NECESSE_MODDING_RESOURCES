...
public class AncientVultureTier
extends SimpleBossSettlementQuestTier {
    ...
    public AncientVultureTier() {
        super("ancientvulture", "ancientvulture");
    }
    ...
    static {
        tierQuests.add(d -> new DeliverItemsSettlementQuest(d.getSettlementName(), null, "mummysbandage", 1));
        tierQuests.add(d -> new DeliverItemsSettlementQuest(d.getSettlementName(), null, "magicsand", 1));
        tierQuests.add(d -> new DeliverItemsSettlementQuest(d.getSettlementName(), null, "caveoyster", 1));
        tierQuests.add(d -> new DeliverItemsSettlementQuest(d.getSettlementName(), null, "capturedspirit", 1));
        tierCompleteRewards = new LootTable(new LootItem("recallflask"));
    }
}
