...
extends SimpleBossSettlementQuestTier {
    ...
    static {
        tierQuests.add(d -> new DeliverItemsSettlementQuest(d.getSettlementName(), null, "slimesample", 1));
        tierQuests.add(d -> new DeliverItemsSettlementQuest(d.getSettlementName(), null, "soakedbow", 1));
        tierCompleteRewards = new LootTable(new LootItem("portalflask"));
    }
}
