...
extends SimpleBossSettlementQuestTier {
    ...
    static {
        tierQuests.add(d -> new DeliverItemsSettlementQuest(d.getSettlementName(), null, "spiderleg", 1));
        tierQuests.add(d -> new DeliverItemsSettlementQuest(d.getSettlementName(), null, "frozenbeard", 1));
        tierCompleteRewards = new LootTable(new LootItem("ammopouch"));
    }
}
