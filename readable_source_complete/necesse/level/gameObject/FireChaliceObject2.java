...
extends FireChaliceAbstractObject {
    ...
    public FireChaliceObject2(String textureName, Color mapColor) {
    ...
    public void addDrawables(List<LevelSortedDrawable> list, OrderableDrawables tileList, Level level, int tileX, int tileY, TickManager tickManager, GameCamera camera, PlayerMob perspective) {
        ...
        synchronized (gameRandom) {
            long tileSeed = this.getMultiTile(rotation).getMasterLevelObject(level, 0, tileX, tileY).map(lo -> FireChaliceObject2.getTileSeed(lo.tileX, lo.tileY)).orElseGet(() -> FireChaliceObject2.getTileSeed(tileX, tileY));
