...
extends FurnitureObject {
    ...
    public CarpetDRObject(String textureName, ToolType toolType, Color mapColor) {
    ...
    public MultiTile getMultiTile(int rotation) {
        return new StaticMultiTile(0, 0, 2, 2, true, this.counterIDTopLeft, this.counterIDTopRight, this.counterIDBotLeft, this.getID());
    }
    ...
    public void addDrawables(List<LevelSortedDrawable> list, OrderableDrawables tileList, Level level, int tileX, int tileY, TickManager tickManager, GameCamera camera, PlayerMob perspective) {
        ...
        TextureDrawOptionsEnd options = texture.initDraw().sprite(1, 1, 32).light(light).pos(drawX, drawY);
    ...
    protected void setCounterIDs(int topLeft, int topRight, int botLeft) {
