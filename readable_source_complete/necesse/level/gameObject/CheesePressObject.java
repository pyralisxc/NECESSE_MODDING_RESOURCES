...
public class CheesePressObject
extends GameObject
implements SettlementWorkstationObject {
    public ObjectDamagedTextureArray texture;
    public ObjectDamagedTextureArray onTexture;
    ...
    public CheesePressObject() {
        ...
        this.mapColor = new Color(143, 120, 114);
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = ObjectDamagedTextureArray.loadAndApplyOverlay((GameObject)this, "objects/cheesepress");
        try {
            this.onTexture = ObjectDamagedTextureArray.loadAndApplyOverlayRaw(this, "objects/cheesepress_on");
        }
    ...
    public ObjectEntity getNewObjectEntity(Level level, int x, int y) {
        return new CheesePressObjectEntity(level, x, y);
    }
