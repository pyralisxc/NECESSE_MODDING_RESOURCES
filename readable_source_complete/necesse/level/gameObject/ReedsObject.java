...
public class ReedsObject
extends GrassObject {
    public static double spreadChance = GameMath.getAverageSuccessRuns(600.0);

    public ReedsObject(String textureName, int undergroundPixels, Color mapColor) {
    ...
    public GrassSpreadOptions getSpreadOptions(Level level) {
        return GrassSpreadOptions.init(this, level).maxSpread(3, 7, 2);
    }
