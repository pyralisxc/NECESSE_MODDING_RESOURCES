...
extends FurnitureObject {
    ...
    public CabinetObject(String textureName, ToolType toolType, Color mapColor, String ... category) {
    ...
    public CabinetObject(String textureName, Color mapColor, String ... category) {
    ...
    public Rectangle getCollision(Level level, int x, int y, int rotation) {
        ...
        return new Rectangle(x * 32 + 16, y * 32, 16, 32);
    }
    ...
    public ObjectEntity getNewObjectEntity(Level level, int x, int y) {
        return new InventoryObjectEntity(level, x, y, 20);
    }
    ...
    protected SoundSettings getInteractSoundOpen() {
        return new SoundSettings(GameResources.cabinetdoorOpen).volume(0.4f);
    }
}
