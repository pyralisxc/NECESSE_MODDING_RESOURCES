...
public class CastleMovesGen
extends CastleChecks {
    ...
    public static final int genCaptureMoves(Board bitboard, long excludedToFieldsIDs, boolean interuptAtFirstExclusionHit, int figureID, int fromFieldID, long freeBitboard, long allOpponentBitboard, int[] figuresIDsPerFieldsIDs, IInternalMoveList list, int maxCount) {
        int count = 0;
        int[] validDirIDs = validDirsIDs[fromFieldID];
        int[][] dirs_ids = dirsFieldIDs[fromFieldID];
        long[][] dirs = dirsBitBoards[fromFieldID];
    ...
    public static final int genCheckMoves(long excludedToFieldsIDs, int figureID, int fromFieldID, int opponentKingFieldID, long freeBitboard, long allMineBitboard, long allOpponentBitboard, int[] figuresIDsPerFieldsIDs, IInternalMoveList list, int maxCount) {
        int count = 0;
