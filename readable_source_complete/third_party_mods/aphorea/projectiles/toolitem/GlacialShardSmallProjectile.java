...
public class GlacialShardSmallProjectile
extends Projectile {
    ...
    public Trail getTrail() {
        return new Trail((Projectile)this, this.getLevel(), AphColors.ice, 4.0f, 30, this.getHeight());
    }
    ...
    public void doHitLogic(Mob mob, LevelObjectHit object, float x, float y) {
        ...
        if (this.isServer() && mob != null) {
            mob.addBuff(new ActiveBuff(BuffRegistry.Debuffs.FROSTBURN, mob, 2000, (Attacker)this), true);
        }
    }
}
