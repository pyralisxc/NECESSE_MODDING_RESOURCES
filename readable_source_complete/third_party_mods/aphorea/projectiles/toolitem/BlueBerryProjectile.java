...
public class BlueBerryProjectile
extends Projectile {
    ...
    public Trail getTrail() {
        return new Trail((Projectile)this, this.getLevel(), AphColors.blueberry, 20.0f, 200, this.getHeight());
    }
    ...
    public void addDrawables(List<LevelSortedDrawable> list, OrderableDrawables tileList, OrderableDrawables topList, OrderableDrawables overlayList, Level level, TickManager tickManager, GameCamera camera, PlayerMob perspective) {
        ...
        TextureDrawOptionsEnd options = this.texture.initDraw().sprite(this.sprite, 0, 14, 14).light(light).rotate(this.getAngle(), this.texture.getWidth() / 4, this.texture.getHeight() / 2).pos(drawX, drawY - (int)this.getHeight());
