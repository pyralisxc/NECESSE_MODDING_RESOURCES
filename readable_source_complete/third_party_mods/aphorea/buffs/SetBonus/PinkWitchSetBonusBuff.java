...
public class PinkWitchSetBonusBuff
extends SetBonusBuff {
    ...
    public ListGameTooltips getTooltip(ActiveBuff ab, GameBlackboard blackboard) {
        ...
        tooltips.add((Object)new StringTooltips(Localization.translate((String)"itemtooltip", (String)"pinkwitchsetbonus")));
        return tooltips;
    }
    ...
    public void clientTick(ActiveBuff buff) {
        ...
        buff.setModifier(BuffModifiers.MAGIC_ATTACK_SPEED, (Object)Float.valueOf(0.5f * (1.0f - owner.getHealthPercent())));
        buff.setModifier(BuffModifiers.COMBAT_MANA_REGEN, (Object)Float.valueOf(0.5f * (1.0f - owner.getHealthPercent())));
        buff.setModifier(BuffModifiers.ARMOR_FLAT, (Object)((int)(6.0f * (1.0f - owner.getHealthPercent()))));
    }
}
