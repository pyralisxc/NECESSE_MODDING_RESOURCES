 ...
 *  necesse.inventory.item.placeableItem.followerSummonItem.petFollowerPlaceableItem.PetFollowerPlaceableItem
 */
...
public class AphPetItem
extends PetFollowerPlaceableItem {
    public AphPetItem(String mobType, Item.Rarity rarity) {
