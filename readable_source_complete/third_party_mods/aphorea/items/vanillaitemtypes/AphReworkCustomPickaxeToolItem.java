...
public class AphReworkCustomPickaxeToolItem
extends CustomPickaxeToolItem {
    ...
    public AphReworkCustomPickaxeToolItem(int attackAnimTime, int toolDps, float toolTier, int attackDamage, int attackRange, int knockback, int enchantCost, Item.Rarity rarity) {
        super(attackAnimTime, toolDps, toolTier, attackDamage, attackRange, knockback, enchantCost, ToolsLootTable.tools, rarity);
    }

    public AphReworkCustomPickaxeToolItem(int attackAnimTime, int toolDps, float toolTier, int attackDamage, int attackRange, int knockback, int enchantCost, Item.Rarity rarity, int addedRange) {
