...
public class MagicalSuit
extends AphChestArmorItem {
    public MagicalSuit() {
        super(2, 300, Item.Rarity.COMMON, "magicalsuit", "magicalsuitarms");
    }

    public ArmorModifiers getArmorModifiers(InventoryItem item, Mob mob) {
        return new ArmorModifiers(new ModifierValue[]{new ModifierValue(BuffModifiers.MAGIC_DAMAGE, (Object)Float.valueOf(0.15f))});
    }
}
