...
public class SwampChestplate
extends AphChestArmorItem {
    public SwampChestplate() {
        super(5, 400, Item.Rarity.COMMON, "swampchest", "swamparms");
    }

    public ArmorModifiers getArmorModifiers(InventoryItem item, Mob mob) {
        return new ArmorModifiers(new ModifierValue[]{new ModifierValue(AphModifiers.MAGIC_HEALING, (Object)Float.valueOf(0.1f)), new ModifierValue(BuffModifiers.MAX_RESILIENCE_FLAT, (Object)2)});
    }
}
