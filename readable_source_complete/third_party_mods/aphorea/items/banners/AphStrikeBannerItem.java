...
public class AphStrikeBannerItem
extends AphAbilityBanner {
    static int range = 200;
    static Color color = AphColors.blood;
    public static AphAreaList areaList = new AphAreaList(new AphArea((float)range, 0.5f, color).setDamageArea(new GameDamage(AphDamageType.INSPIRATION, 30.0f, 5.0f)));

    public AphStrikeBannerItem() {
        super(Item.Rarity.LEGENDARY, 480, (Mob m) -> AphBuffs.BANNER.STRIKE, 40, 10, new String[0]);
    }
