...
public class GrassNoBreakSoundWhenNoDamage {
    ...
    static boolean onEnter(@Advice.This GrassObject grassObject, @Advice.Argument(value=0) Level level, @Advice.Argument(value=1) int x, @Advice.Argument(value=2) int y, @Advice.Argument(value=3) GameDamage damage) {
    ...
    @Advice.OnMethodExit
    static void onExit(@Advice.This GrassObject grassObject, @Advice.Argument(value=0) Level level, @Advice.Argument(value=1) int x, @Advice.Argument(value=2) int y, @Advice.Argument(value=3) GameDamage damage) {
    }
}
